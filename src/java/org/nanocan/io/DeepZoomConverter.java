 ...
 *    Markus List <mlist@health.sdu.dk>
 *
...
public class DeepZoomConverter {
    ...
    static final String descriptorFileEnding = ".xml";
     ...
     */
    private static void processImageFile(File inFile, File outputDir, int overlap, int size) throws IOException {
        tileOverlap = overlap;
        tileSize = size;
    ...
    private static void processImageFile(File inFile, File outputDir) throws IOException {
        ...
        File descriptor = new File(pathWithoutExtension + descriptorFileEnding);
